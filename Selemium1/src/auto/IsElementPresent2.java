...
public class IsElementPresent2 {
	...
	public List<WebElement> getElementList(String locator, String type){
		...
		if(elementList.isEmpty()) System.out.println("find by " + type + ": " + locator + " not found") ;
		else System.out.println("find by type :" + type + ", "+locator) ;
		
		return elementList;
	}
	
	public boolean isElementListPresent2(String locator, String type) {
